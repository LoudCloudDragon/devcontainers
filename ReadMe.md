...
If you are going to download the dockerfile and mod it, don't forget to adjust the git email & user name lines (74/75). If you are going to pull the image, same thing, config those entries b/c they having placeholder data.
...
$env:GIT_EMAIL = "your-email@example.com"
```
